...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 7, 1);
 	...
 	ivoc_help("help ?1 hd /home/ai-shwarya/CAMP/neuron/x86_64/h.mod\n");
...
static int  rate (  double _lv ) {
 ...
 _lqt = pow( q10 , ( ( celsius - 33.0 ) / 10.0 ) ) ;
   ...
   taul = tfactor * bett ( _threadargscomma_ _lv ) / ( qtl * _lqt * a0t * ( 1.0 + _la ) ) ;
    return 0; }
